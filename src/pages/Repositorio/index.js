...
export default function Repositorio() {
    ...
    return (
        <Container>
            <BackButton to="/">
                <FaArrowLeft color='#0d2636F' size={30}/>
            </BackButton>
           ...
           <Owner>
            ...
            <PageActions>
                <button type='button' onClick={()=>handlePaga('back')} disabled={page < 2 } >Voltar</button>
                <button type='button' onClick={()=> handlePaga('next')}>Proxima</button>
            </PageActions>
